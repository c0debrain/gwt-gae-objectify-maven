 ...
 */
@Singleton
public class CellTreeExample2 extends Composite {
	...
	private static class CustomTreeModel implements TreeViewModel {
		...
		public CustomTreeModel() {
			...
			// Add compositions by Beethoven.
			{
				...
				Playlist concertos = beethoven.addPlaylist(new Playlist(
						"Concertos"));
				...
				Playlist quartets = beethoven.addPlaylist(new Playlist(
						"Quartets"));
				...
				Playlist sonatas = beethoven
						.addPlaylist(new Playlist("Sonatas"));
				sonatas.addSong("Sonata in A Minor");
				sonatas.addSong("Sonata in F Major");

				Playlist symphonies = beethoven.addPlaylist(new Playlist(
						"Symphonies"));
			...
			// Add compositions by Brahms.
			{
				...
				Playlist concertos = brahms.addPlaylist(new Playlist(
						"Concertos"));
				...
				Playlist quartets = brahms
						.addPlaylist(new Playlist("Quartets"));
				...
				Playlist symphonies = brahms.addPlaylist(new Playlist(
						"Symphonies"));
			...
			// Add compositions by Mozart.
			{
				...
				Playlist concertos = mozart.addPlaylist(new Playlist(
						"Concertos"));
